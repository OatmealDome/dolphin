...
public:
  BytecodeInterpreterEmitter() = default;
  explicit BytecodeInterpreterEmitter(u8* begin, u8* end) : m_code(begin), m_code_end(end) {}
...
class BytecodeInterpreterCodeBlock : public Common::CodeBlock<BytecodeInterpreterEmitter, false>
{
private:
